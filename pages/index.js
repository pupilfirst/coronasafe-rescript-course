      ...
      <main className={"MAIN text-xl"}>
        ...
        <section className="highlights-bg p-8 md:p-16 lg:p-32 font-inter font-bold text-3xl leading-snug">
          <div className="C-pwidth mx-auto">
            ...
            Internship opportunity with CoronaSafe building open-source
            software.&nbsp;
            <span className="text-gray-700">
          ...
          <div className="C-pwidth mx-auto leading-normal">
            ...
            <div className="mb-16">
              ...
              <p>
                ...
                you will learn, and how you will learn. Each of your code
                submission will be reviewed in depth by a coach and your code
                will get kind, courteous feedback. We will look at basics like
                automated code formatting, naming, and programming idioms. Those
                are but table stakes. More importantly, you will learn
                high-level design around abstraction boundaries, data modelling,
                layering, and so on.{" "}
              </p>
            </div>
            <div className="mb-16">
