...
function ImageWithDescription({ name, caption, imgSrc }) {
  return (
    <div>
      ...
      <h4 className={"text-lg text-primary-500 pt-4"}>{name}</h4>
            ...
            <div className="lg:grid lg:grid-cols-5 lg:gap-8">
              <div className="lg:col-span-3">
                ...
                <div className="space-y-10 pr-12 pt-10">
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">What is this?</h3>
                    <p className="ml-16 pt-1 text-white">Industry-led advanced programming training for students.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Why?</h3>
                    <p className="ml-16 pt-1 text-white">To train you to help contribute open-source code for CoronaSafe disaster management.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Who is this for?</h3>
                    <p className="ml-16 pt-1 text-white">Age 18+ students who enjoy programming. You should have written at least some amount of code yourselves before, either on personal projects or college projects.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">When?</h3>
                    <p className="ml-16 pt-1 text-white">January 15 - March 25, 2021</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Effort?</h3>
                    <p className="ml-16 pt-1 text-white">120 hours of highly enjoyable study & programming. About 10 weekends worth.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Format?</h3>
                    <p className="ml-16 pt-1 text-white">Self-paced learning via video tutorials, but between specified programming assignment dates.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Mentorship?</h3>
                    <p className="ml-16 pt-1 text-white">Weekly sessions with mentors and fellow students, AMAs with industry veterans, code reviews, and dedicated Q&amp;A forum.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Stack?</h3>
                    <p className="ml-16 pt-1 text-white">ReScript/OCaml. Ruby on Rails. React. PostgreSQL. Typed FP. Relax! You'll learn all these in the course and no prior knowledge of them is required.</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Certificate?</h3>
                    <p className="ml-16 pt-1 text-white">Yes</p>
                  </div>
                  <div>
                    <h3 className="heading-with-underscore text-primary-500 font-montserrat font-medium">Cost</h3>
                    <p className="ml-16 pt-1 text-white">Free</p>
                  </div>
                </div>
              </div>
        ...
        <section>
          <div className="max-w-6xl mx-auto border-l border-gray-600">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="lg:grid lg:grid-cols-3 lg:gap-12 pt-12 pb-20">
            ...
            <div className="max-w-3xl mx-auto pt-10 pb-24">
              <div className="rounded-lg bg-gradient-to-b from-primary-400 to-primary-700 p-12">
                ...
                <div className="mt-4 flex justify-center">
                  <a
                    className="block px-10 py-4 bg-gray-900 text-primary-500 border border-primary-500 font-bold font-montserrat rounded shadow-lg hover:shadow-xl hover:bg-primary-900 hover:text-gray-900 transition duration-250 ease-in-out"
                    href="https://apply.pupilfirst.org"
                  >
